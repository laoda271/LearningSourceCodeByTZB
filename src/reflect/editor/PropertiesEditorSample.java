...
public class PropertiesEditorSample {
    ...
    public static void main(String[] args) throws IllegalAccessException, IntrospectionException, InvocationTargetException {
        ...
        };//模拟参数信息，就像request的parameterMap类似
        TestDO testDO = convertParameterToDO(parameter);
        System.out.println(testDO.getNodeName());
        System.out.println(testDO.getNodeDO());
    }

    public static TestDO convertParameterToDO(Map<String,String> parameter) throws InvocationTargetException, IllegalAccessException, IntrospectionException {
        ...
        for (Field field :
            ...
            if(field.getType() == String.class){
                writeMethod.invoke(testDO,parameter.get(field.getName()));
            }else{
                ...
                if(propertyEditor != null){
                    ...
                    writeMethod.invoke(testDO,propertyEditor.getValue());
                }else{
